...
const circleRadius = 1;
  ...
  pointOnLine
    .enter().append("circle")
    .attr("class", "dot")
    .attr("cx", lineGeneratorFrance.x())
    .attr("cy", lineGeneratorFrance.y())
    .attr("r", 3.5)
    .attr('opacity',0)
    .transition().duration(transitionDuration*5)
    .attr('opacity',1);
  ...
  pointOnLine
    ...
    .attr("class", "dot")
    .style("stroke", "black")
    .attr("x1", lineGeneratorFrance.x())
    .attr("y1", lineGeneratorFrance.y())
    .attr("x2", 950)
    .attr("y2", 330)
    .attr('opacity',0)
    .transition().duration(transitionDuration*5)
  ...
  pointOnLine
    .enter().append("circle")
    .attr("class", "dot")
    .attr("cx", lineGeneratorGermany.x())
    .attr("cy", lineGeneratorGermany.y())
    .attr("r", 3.5)
    .attr('opacity',0)
    .transition().duration(transitionDuration*4)
    .attr('opacity',1);
  ...
  pointOnLine
    ...
    .attr("class", "dot")
    .style("stroke", "black")
    .attr("x1", lineGeneratorGermany.x())
    .attr("y1", lineGeneratorGermany.y())
    .attr("x2", 850)
    .attr("y2", 430)
    .attr('opacity',0)
    .transition().duration(transitionDuration*4)
...
d3.csv("data/covid_data_quarterly.csv").then(rawData => {
  data = rawData.map(d => ({

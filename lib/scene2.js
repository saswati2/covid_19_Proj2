...
const renderScene2 = (svgId, data) => {
  ...
  const waveAnnotations = [
    { date: new Date('2020-06-24'), label: '2nd wave in USA', country: 'US' },
    { date: new Date('2020-07-24'), label: '2nd wave in India', country: 'India' },
    { date: new Date('2020-10-27'), label: '2nd wave in Germany', country: 'Germany' },
    { date: new Date('2020-10-21'), label: '2nd wave in France', country: 'France' },
    { date: new Date('2020-11-21'), label: '2nd wave in Brazil', country: 'Brazil' },
    { date: new Date('2020-11-02'), label: '3rd wave in USA', country: 'US' },
    { date: new Date('2021-04-01'), label: '3rd wave in India', country: 'India' },
    { date: new Date('2021-03-25'), label: '3rd wave in Germany', country: 'Germany' },
    { date: new Date('2020-10-25'), label: '3rd wave in France', country: 'France' },
    { date: new Date('2021-04-01'), label: '3rd wave in Brazil', country: 'Brazil' },
    { date: new Date('2021-12-10'), label: '4th wave in USA', country: 'US' },
    { date: new Date('2022-01-01'), label: '4th wave in India', country: 'India' },
    { date: new Date('2022-01-07'), label: '4th wave in Germany', country: 'Germany' },
    { date: new Date('2021-12-19'), label: '4th wave in France', country: 'France' },
    { date: new Date('2022-01-17'), label: '4th wave in Brazil', country: 'Brazil' }
  ];
  ...
  Object.keys(lineGenerators).forEach((country, i) => {
    ...
    waveAnnotations.filter(annotation => annotation.country === country).forEach(annotation => {
      const annotationX = xScale(annotation.date);
      const annotationY = yScale(data.find(d => d.Time >= annotation.date)[country]);

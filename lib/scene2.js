...
const renderScene2 = (svgId, data) => {
  ...
  const waveAnnotations = [
    { date: new Date('2020-06-24'), label: '2nd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-07-24'), label: '2nd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-10-21'), label: '2nd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-10-27'), label: '2nd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-11-21'), label: '2nd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-11-02'), label: '3rd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2021-04-01'), label: '3rd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2020-10-25'), label: '3rd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2021-03-25'), label: '3rd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2021-04-01'), label: '3rd Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2021-12-10'), label: '4th Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2022-01-01'), label: '4th Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2021-12-19'), label: '4th Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2022-01-07'), label: '4th Wave', xOffset: 20, yOffset: -10 },
    { date: new Date('2022-01-17'), label: '4th Wave', xOffset: 20, yOffset: -10 }
  ];
  ...
  waveAnnotations.forEach(annotation => {
    ...
    const points = Object.keys(lineGenerators).map(country => {
      const y = yScale(data.find(d => d.Time >= annotationDate)[country]);
      return { country, x: x1, y };
    });
    ...
    points.forEach(point => {
      ...
      g.merge(gEnter).append('line')
        ...
        .attr('x1', point.x)
        .attr('y1', point.y)
        .attr('x2', x1 + annotation.xOffset)
        .attr('y2', point.y + annotation.yOffset)
        .attr('opacity', 0)
        .transition().duration(transitionDuration)
        .attr('opacity', 1);
    });
    ...
    g.merge(gEnter).append('rect')
      .attr('transform', `translate(${x1 + annotation.xOffset},${points[0].y + annotation.yOffset - 20})`)
    ...
    g.merge(gEnter).append('text')
      .attr('transform', `translate(${x1 + annotation.xOffset + 10},${points[0].y + annotation.yOffset + 10})`)

...
const renderScene2 = (svgId, data) => {
  ...
  const annotationDate2 = new Date('2020-11-02');
  ...
  gEnter.append('line')
    ...
    .attr('y2', annotationY2 - 60)  // 60 pixels above the curve
    .attr('stroke', 'black')
    .attr('stroke-width', 2)
    .attr('stroke-dasharray', '4,4');
  ...
  const text2 = "Starting of Second wave caused by Delta variant in US";
  const textWidth2 = 300;
  const textHeight2 = 40;

  gEnter.append('rect')
    .attr('x', annotationX2 - textWidth2 / 2 - textBoxPadding2)
    .attr('y', annotationY2 - textHeight2 - 60 - textBoxPadding2) // Positioned 60 pixels above
    .attr('width', textWidth2 + 3 * textBoxPadding2)
  ...
  gEnter.append('text')
    .attr('x', annotationX2)
    .attr('y', annotationY2 - textHeight2 / 2 - 60 + textBoxPadding2) // Positioned 60 pixels above
    .attr('text-anchor', 'middle')
    .attr('font-size', '12px')
    .attr('font-weight', 'bold')
    .text(text2);

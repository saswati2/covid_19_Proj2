...
const renderScene2 = (svgId, data) => {
  ...
  // Annotation for January 8, 2022
  const annotationDate1 = new Date('2022-01-08');
  ...
  // Annotation for Dec 10, 2021
  const annotationDate2 = new Date('2021-12-10');
  ...
  gEnter.append('polygon')
    .attr('points', `${annotationX2 - 5},${innerHeight - 10} ${annotationX2 + 5},${innerHeight - 10} ${annotationX2},${innerHeight - 30}`)
    .attr('fill', 'red');

  // Text with background box
  const textBoxPadding2 = 6;
  const text2 = "Start of 4th wave due to Omicron in the US";
  const textWidth2 = 260;
  const textHeight2 = 24;

  gEnter.append('rect')
    .attr('x', annotationX2 - textWidth2 / 2 - textBoxPadding2)
    .attr('y', -textHeight2 - textBoxPadding2)
  ...
  gEnter.append('text')
    .attr('x', annotationX2)
    .attr('y', -textBoxPadding2)
    .attr('text-anchor', 'middle')
    .attr('dominant-baseline', 'central')
    .text(text2);

  // Annotation for May 6, 2021
  ...
  gEnter.append('polygon')
    .attr('points', `${annotationX3 - 5},${innerHeight - 10} ${annotationX3 + 5},${innerHeight - 10} ${annotationX3},${innerHeight - 30}`)
    .attr('fill', 'blue');

  // Text with background box
  const textBoxPadding3 = 6;
  const text3 = "Middle of 3rd wave spike due to Delta Variant in India";
  const textWidth3 = 420;
  const textHeight3 = 24;

  gEnter.append('rect')
    .attr('x', annotationX3 - textWidth3 / 2 - textBoxPadding3)
    .attr('y', -textHeight3 - textBoxPadding3 - 30)

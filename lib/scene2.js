...
const renderScene2 = (svgId, data) => {
  ...
  const trendlines = {
    US: createTrendline('US'),
    India: createTrendline('India'),
    France: createTrendline('France'),
    Germany: createTrendline('Germany'),
    Brazil: createTrendline('Brazil'),
  };
  ...
  const addAnnotations = (trendline, cx, cy, x2, y2, text) => {
    pointOnLine.enter().append("circle")
      .attr("class", "dot")
      .attr("cx", trendline.x()(cx))
      .attr("cy", trendline.y()(cy))
      .attr("r", 3.5)
      .attr('opacity', 0)
    ...
    pointOnLine.enter().append("line")
      .attr("class", "dot")
      .style("stroke", "black")
      .attr("x1", trendline.x()(cx))
      .attr("y1", trendline.y()(cy))
      .attr("x2", x2)
      .attr("y2", y2)
      .attr('opacity', 0)
      .transition().duration(transitionDuration)
  ...
  addAnnotations(trendlines.US, data[151], data[151], 1050, 240, "Starting of Second Wave");
  addAnnotations(trendlines.Brazil, data[151], data[151], 950, 330, "Still into First Wave");
  addAnnotations(trendlines.India, data[151], data[151], 950, 330, "Annotation for India");
  addAnnotations(trendlines.France, data[151], data[151], 950, 330, "Annotation for France");
  addAnnotations(trendlines.Germany, data[151], data[151], 850, 430, "Flattening the First Wave");

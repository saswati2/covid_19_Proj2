...
const renderScene2 = (svgId, data) => {
  ...
  addAnnotations(trendlines.US, data[151], data[151].US, 1050, 240, "Starting of Second Wave");
  addAnnotations(trendlines.Brazil, data[151], data[151].Brazil, 950, 330, "Still into First Wave");
  addAnnotations(trendlines.India, data[151], data[151].India, 950, 330, "Annotation for India");
  addAnnotations(trendlines.France, data[151], data[151].France, 950, 330, "Annotation for France");
  addAnnotations(trendlines.Germany, data[151], data[151].Germany, 850, 430, "Flattening the First Wave");
